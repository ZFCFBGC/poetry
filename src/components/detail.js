    ...
    render(){
        ...
        return <div className="detail">
            <NavBar
                ...
                rightContent={[
                    <Icon key="1" type="search" style={{ marginRight: '16px' }} onClick={this.goSearch.bind(this)}/>,
                    <Icon key="2" type="ellipsis" style={{ marginRight: '16px' }}/>
                ]}
                 leftContent={[
                    <Icon key="0" type="left" style={{ marginRight: '16px' }} onClick={this.goLeft.bind(this)}/>
                ]}
            ></NavBar>
            ...
            {this.state.abstract.length>0? <div className="abstract"><h3>姓名：{this.state.abstract[0].name}</h3><p>{this.state.abstract[0].desc}</p></div> : '' }
